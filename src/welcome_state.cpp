  ...
  mTableRow4Sprite(game)
{
  ...
  mSinglePlayerText.setText("PRESS [X] FOR A 1 PLAYER GAME");
  ...
  mMultiPlayerText.setText("PRESS [Y] FOR A 2 PLAYER GAME");
  ...
  mControlsText.setText("USE ARROW KEYS AND A TO PLAY");
...
void WelcomeState::onKeyUp(SDL_JoyButtonEvent& event)
{
  switch (event.button) {
  case 2: // X (1)
...
void WelcomeState::onKeyDown(SDL_JoyButtonEvent& event)
{
  // ...
}
